// <copyright file="ProgressTimerController.cs" company="Salesforce, Inc.">
...
/// <inheritdoc/>
public class ProgressTimerController : IProgressTimerController
{
    /// <inheritdoc/>
    ...
    {
        this.OnMigrationStarted?.Invoke();
    }

    /// <inheritdoc/>
    public void CompleteMigration()
    {
        this.OnMigrationCompleted?.Invoke();
    }
}
